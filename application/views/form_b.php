                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box box-info">
                                ...
                                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?=base_url()?>user/insert_penduduk">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="tiga" class="col-sm-2 control-label">NIK (*)</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" placeholder="Nomor Induk KTP" name="nik" id="tiga" value="" maxlength="16" pattern="[0-9]{16}" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="tiga" class="col-sm-2 control-label">Nama Lengkap</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" placeholder="Nama Lengkap" name="nama_lengkap" id="tiga" value="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="tiga" class="col-sm-2 control-label">Tempat & Tanggal Lahir</label>
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" placeholder="Tempat Lahir" name="tempat_lahir" id="tiga" value="">
                                            </div>
                                            <div class="col-sm-3">
                                                <input type="date" class="form-control" name="tgl_lahir" id="tiga" value="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" placeholder="Alamat" name="alamat" id="tiga" value="">
                                            </div>
                                            <div class="col-sm-2">
                                                <input type="text" placeholder="RT" class="form-control" name="rt" id="tiga" value="" >
                                            </div>
                                            <div class="col-sm-2">
                                                <input type="text" placeholder="RW" class="form-control" name="rw" id="tiga" value="" >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="tiga" class="col-sm-2 control-label"></label>
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" placeholder="Kel/Desa" name="kelurahan" id="tiga" value="">
                                            </div>
                                            <div class="col-sm-5">
                                                <input type="text" placeholder="Kecamatan" class="form-control" name="kecamatan" id="tiga" value="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <div class="radio">
                                                    <label><input type="radio" name="status" value="belum">Belum Kawin</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
